...
//  shapes
//
//  Created by Aniket Singh on 01/01/23.
//
    ...
    var body: some View {
        ZStack{
                        ...
                        Hexagon()
                            ...
                            .overlay(
                                Image(symbols[numbers[0]])
                                    ...
                                    .shadow(color: .gray, radius: 4, x: 8, y:8)
                            )
            ...
            .alert(item: $showingAlert){ alert -> Alert in
                switch alert{
                case .success:
                    return Alert(title: Text("Yaaah!!, You Won"), message: Text("Born with charm"), dismissButton: .cancel())
                case .failure:
                    return Alert(title: Text("Naaah!!, Bad Luck"), message: Text("Better Luck Next Time"), dismissButton: .cancel())
                }
            }
        }
    }
